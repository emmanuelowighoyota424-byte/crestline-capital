      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">Our <span className="chase-text-gradient">Services</span></h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Link key={i} href={service.link} className="feature-card group cursor-pointer">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-[#0a4fa6] transition-colors">{service.title}</h3>
