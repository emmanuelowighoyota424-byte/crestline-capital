      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">Contact <span className="chase-text-gradient">Us</span></h1>
            <p className="text-lg text-gray-500">We&apos;re here to help. Reach out anytime.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {[
              { icon: "📞", title: "Phone", detail: "1-888-CREST-01", sub: "24/7 Support" },
              { icon: "✉️", title: "Email", detail: "support@chasecapital.com", sub: "Response within 24h" },
              ...
              <div key={i} className="feature-card text-center">
                ...
                <p className="text-sm text-[#0a4fa6]">{contact.detail}</p>
          ...
          {submitted ? (
            <div className="max-w-lg mx-auto text-center p-8 rounded-2xl bg-gray-100 border border-[#10b981]/30">
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true) }} className="max-w-lg mx-auto space-y-4">
              <div>
                ...
                <input type="text" required className="w-full px-4 py-3 rounded-xl bg-gray-100 border border-gray-200 text-gray-900 focus:border-[#0a4fa6] focus:outline-none transition-colors" placeholder="Your name" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-500 mb-1">Email</label>
                <input type="email" required className="w-full px-4 py-3 rounded-xl bg-gray-100 border border-gray-200 text-gray-900 focus:border-[#0a4fa6] focus:outline-none transition-colors" placeholder="you@example.com" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-500 mb-1">Subject</label>
                <select className="w-full px-4 py-3 rounded-xl bg-gray-100 border border-gray-200 text-gray-900 focus:border-[#0a4fa6] focus:outline-none transition-colors">
              ...
              <div>
                ...
                <textarea required rows={5} className="w-full px-4 py-3 rounded-xl bg-gray-100 border border-gray-200 text-gray-900 focus:border-[#0a4fa6] focus:outline-none transition-colors resize-none" placeholder="How can we help?" />
              </div>
              <button type="submit" className="w-full py-3 bg-[#0a4fa6] text-gray-900 rounded-xl font-bold hover:bg-[#083d80] transition-all">
                Send Message
              </button>
            </form>
          )}
