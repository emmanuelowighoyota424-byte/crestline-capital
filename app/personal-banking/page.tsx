      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">Personal <span className="chase-text-gradient">Banking</span></h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { title: "Chase Checking", rate: "No monthly fees", features: ["Free debit card", "Mobile check deposit", "Unlimited transactions", "Early direct deposit", "ATM fee reimbursement"], color: "#38bdf8" },
              { title: "Chase Savings", rate: "Up to 4.50% APY", features: ["High-yield returns", "No minimum balance", "Automatic round-ups", "Savings goals", "FDIC insured"], color: "#10b981" },
              { title: "Chase Premium Checking", rate: "Priority service", features: ["Dedicated relationship manager", "Priority customer support", "Enhanced rewards", "Fee-free wire transfers", "Concierge services"], color: "#f59e0b" },
              { title: "Chase Youth Account", rate: "For ages 13-17", features: ["Parental controls", "Spending limits", "Savings tools", "Financial literacy", "No fees"], color: "#8b5cf6" },
            ].map((account, i) => (
              <div key={i} className="p-6 rounded-2xl bg-gray-100/60 border border-gray-200 hover:border-[#0a4fa6]/20 transition-all">
                ...
                <button className="mt-6 w-full py-2.5 rounded-xl border border-gray-200 text-gray-900 text-sm font-semibold hover:border-[#0a4fa6]/30 hover:bg-white/50 transition-all">
                  Learn More
                </button>
              </div>
            ))}
