        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gradient-to-r from-[#161e2e] via-[#1a2337] to-[#161e2e] border border-[#1e293b] rounded-2xl p-6 shadow-xl">
          <div>
            ...
            <p className="text-sm text-[#94a3b8] mt-1">
              Here is your financial overview and real-time liquidity status.
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/deposits"
              className="px-4 py-2.5 bg-[#0b0f19] hover:bg-[#1e293b] text-white border border-[#1e293b] font-medium text-xs rounded-xl transition-all flex items-center gap-2"
            >
        ...
        <div className="bg-[#161e2e] border border-[#1e293b] rounded-2xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
            {[
              ...
              { label: 'Apply Loan', href: '/loans', icon: FileText, color: 'text-indigo-400' },
            ].map((action) => {
