        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/register"
                className="px-4 py-2 bg-[#0a4fa6] hover:bg-[#083d80] text-gray-900 font-bold text-xs rounded-xl"
              >
      ...
      <div className="pt-32 pb-20 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-gray-100 border border-gray-200 rounded-2xl p-7 shadow-xl">
            <div className="w-12 h-12 rounded-xl bg-[#0a4fa6]/10 text-[#0a4fa6] flex items-center justify-center mb-4">
        ...
        <div className="bg-gradient-to-r from-[#0a4fa6] via-[#083d80] to-[#0a4fa6] border border-gray-200 rounded-3xl p-8 sm:p-12 text-center max-w-4xl mx-auto">
          ...
          <Link
            href="/register"
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#0a4fa6] hover:bg-[#083d80] text-gray-900 font-bold text-sm rounded-xl"
          >
