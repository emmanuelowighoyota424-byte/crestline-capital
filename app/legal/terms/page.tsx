      ...
      <div className="pt-32 pb-20 px-4 max-w-4xl mx-auto">
        ...
        <div className="bg-gray-100 border border-gray-200 rounded-2xl p-6 sm:p-10 shadow-xl space-y-6 text-sm text-gray-500 leading-relaxed">
          <section>
            ...
            <p>
              Banking services provided by Chase Partner Bank, Member FDIC. The Chase Visa® Debit and Credit Cards are issued by our partner financial institutions pursuant to a license from Visa U.S.A. Inc. and may be used anywhere Visa debit cards are accepted.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All transfer authorizations, debit commitments, and settlement events executed within the Chase platform are immutably recorded via our double-entry ledger architecture. Funds transfer requests submitted past clearing cutoffs will settle on the subsequent Federal Reserve banking day.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Under Regulation E, consumers have specific rights regarding unauthorized electronic fund transfers. If you believe your credentials, card, or account access has been compromised, you must notify Chase immediately via our 24/7 hotline at 1-800-555-0199.
            </p>
          </section>
        </div>
      </div>
