  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3.5 py-2 bg-emerald-500 hover:bg-emerald-600 text-[#0b0f19] text-xs font-bold rounded-xl transition-all flex items-center gap-1.5"
            >
            ...
            {deposits.length === 0 ? (
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-[#1e293b]/60">
                  {deposits.map((dep) => (
                    <tr key={dep.id} className="hover:bg-[#1e293b]/30">
                      <td className="py-3 px-4 font-mono text-white font-medium">{dep.userEmail}</td>
                      <td className="py-3 px-4 font-mono font-bold text-emerald-400">
                        ${dep.amount.toLocaleString()} {dep.currency}
                      </td>
                      <td className="py-3 px-4">
                        <span className="px-2 py-0.5 rounded bg-[#0b0f19] text-[#94a3b8] font-mono text-[10px]">
                          {dep.method}
                        </span>
                      </td>
                      <td className="py-3 px-4 font-mono text-[#94a3b8]">{dep.reference}</td>
                      <td className="py-3 px-4">
                        <span
                      ...
                      <td className="py-3 px-4 text-right">
                        {dep.status === 'PENDING' ? (
                          <button
                            ...
                            className="px-3 py-1 bg-emerald-500 hover:bg-emerald-600 text-[#0b0f19] font-bold rounded-lg text-xs transition-colors"
                          >
                            Approve Deposit
                          </button>
                        ) : (
                          <span className="text-[11px] text-[#64748b] font-mono">Ledger Committed</span>
                        )}
                      </td>
                    </tr>
                  ))}
          ...
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-2xl overflow-hidden shadow-xl">
            {withdrawals.length === 0 ? (
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-[#1e293b]/60">
                  {withdrawals.map((wth) => (
                    <tr key={wth.id} className="hover:bg-[#1e293b]/30">
                      <td className="py-3 px-4 font-mono text-white">{wth.userEmail}</td>
                      <td className="py-3 px-4 font-mono font-bold text-amber-400">
                        ${wth.amount.toLocaleString()} {wth.currency}
                      </td>
                      <td className="py-3 px-4 font-mono text-[#94a3b8]">{wth.destination}</td>
                      <td className="py-3 px-4 font-mono text-emerald-400">{wth.riskScore}/100</td>
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4 text-right">
                        {wth.status === 'PENDING' && (
                          <button
                            ...
                            className="px-3 py-1 bg-amber-500 hover:bg-amber-600 text-[#0b0f19] font-bold rounded-lg text-xs"
                          >
                            Approve Payout
                          </button>
                        )}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-2xl p-6 shadow-xl">
            <div className="flex items-center justify-between border-b border-[#1e293b] pb-4 mb-4">
              <div>
                <span className="text-xs text-[#94a3b8]">Double-Entry Balancing State</span>
                <div className="text-base font-bold font-mono text-emerald-400">
                  DEBITS == CREDITS (100.00% Balanced)
                </div>
              </div>
              <span className="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 font-mono text-xs border border-emerald-500/20">
                Ledger Core Active
              </span>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-2xl p-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div>
                <label className="text-[#94a3b8] block mb-1">Fedwire Routing Number</label>
                <input
                  type="text"
                  value={wireRouting}
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">SWIFT / BIC Code</label>
                <input
                  type="text"
                  value={wireSwift}
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">BTC Treasury Deposit Address</label>
                <input
                  type="text"
                  value={btcAddress}
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">ETH/ERC-20 Treasury Vault</label>
                <input
                  type="text"
                  value={ethAddress}
            ...
            <div className="flex justify-end pt-2">
              <button
                ...
                className="px-4 py-2 bg-[#38bdf8] text-[#0b0f19] font-bold rounded-xl text-xs hover:bg-[#0ea5e9]"
              >
      ...
      {activeModuleId === '17' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {cards.map((card) => (
              <div key={card.id} className="bg-[#161e2e] border border-[#1e293b] rounded-2xl p-5 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-sm text-white">{card.holderName}</span>
                  <span
                    className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                      card.status === 'ACTIVE'
                        ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20'
                ...
                <div className="font-mono text-lg text-[#38bdf8] tracking-widest">{card.maskedPan}</div>
                <div className="text-xs text-[#94a3b8] space-y-1">
                  <div>Monthly Limit: <span className="text-white font-mono">${card.spendingLimitMonthly.toLocaleString()}</span></div>
                  <div>Spent This Month: <span className="text-white font-mono">${card.spentThisMonth.toLocaleString()}</span></div>
                  <div>Type: <span className="text-white">{card.type}</span> • Exp: <span className="text-white font-mono">{card.expiry}</span></div>
                </div>
              </div>
            ))}
          </div>
      ...
      {activeModuleId === '18' && (
        <div className="space-y-6">
          ...
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-2xl p-6 space-y-4 text-xs">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="text-[#94a3b8] block mb-1">Assigned Issuer BIN Range</label>
                <input
                  type="text"
                  value={binRange}
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">Domestic Interchange Fee</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">Max Contactless Tap Limit</label>
                <input
                  type="text"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-2xl overflow-hidden shadow-xl">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#1e293b]/60">
                {currencies.map((curr) => (
                  <tr key={curr.code} className="hover:bg-[#1e293b]/30">
                    <td className="py-3 px-4 font-bold text-white">
                      {curr.symbol} {curr.name}
                    </td>
                    <td className="py-3 px-4 font-mono text-[#38bdf8]">{curr.code}</td>
                    <td className="py-3 px-4 font-mono font-bold text-white">{curr.rateAgainstUSD}</td>
                    <td className="py-3 px-4">
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                        {curr.enabled ? 'ENABLED' : 'DISABLED'}
                      </span>
                    </td>
                    <td className="py-3 px-4 text-[#94a3b8] font-mono">{curr.lastUpdated}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {activeModuleId === '20' && (
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {loans.map((loan) => (
              <div key={loan.id} className="bg-[#161e2e] border border-[#1e293b] rounded-2xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-base text-white">{loan.applicantName}</span>
                    <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-[#38bdf8]/10 text-[#38bdf8]">
                      FICO {loan.creditScore}
                    </span>
                  </div>
                  <div className="text-xs text-[#94a3b8] mt-1 space-x-3">
                    <span>Principal: <strong className="text-white font-mono">${loan.principal.toLocaleString()}</strong></span>
                    <span>APR: <strong className="text-emerald-400 font-mono">{loan.apr}%</strong></span>
                    <span>Term: <strong className="text-white">{loan.termMonths} Mos</strong></span>
                    <span>Monthly: <strong className="text-white font-mono">${loan.monthlyPayment.toFixed(2)}</strong></span>
                  </div>
                  <div className="text-xs text-[#64748b] mt-1">Purpose: {loan.purpose}</div>
                </div>

                <span className="px-3 py-1 rounded-full text-xs font-bold font-mono bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 self-start md:self-auto">
                  {loan.status}
                </span>
              </div>
            ))}
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3.5 py-2 bg-amber-400 hover:bg-amber-500 text-[#0b0f19] text-xs font-bold rounded-xl transition-all flex items-center gap-1.5"
            >
              <Plus className="w-4 h-4" />
          ...
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-2xl overflow-hidden shadow-xl">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#1e293b]/60">
                {grants.map((g) => (
                  <tr key={g.id} className="hover:bg-[#1e293b]/30">
                    <td className="py-3 px-4 font-bold text-white">{g.title}</td>
                    <td className="py-3 px-4 font-mono text-[#38bdf8]">{g.recipientEmail}</td>
                    <td className="py-3 px-4 font-mono font-bold text-emerald-400">
                      ${g.amount.toLocaleString()} {g.currency}
                    </td>
                    <td className="py-3 px-4 text-[#94a3b8]">{g.category}</td>
                    <td className="py-3 px-4">
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                        {g.status}
                      </span>
                    </td>
                    <td className="py-3 px-4 text-[#94a3b8] font-mono">{g.issuedAt}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-2xl p-6 space-y-4 text-xs">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-[#94a3b8] block mb-1">Statutory Backup Withholding Rate (%)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">IRS TIN Matching Gateway Status</label>
                <div className="px-3 py-2 bg-[#0b0f19] border border-[#1e293b] rounded-xl text-emerald-400 font-mono flex items-center justify-between">
      ...
      {activeModuleId === '23' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { tier: 'STANDARD', min: '$0', boost: '0.00%', fee: '$0/mo', color: 'text-[#94a3b8]' },
              { tier: 'GOLD', min: '$25,000', boost: '+0.25%', fee: '$49/mo', color: 'text-amber-400' },
              { tier: 'PLATINUM', min: '$100,000', boost: '+0.60%', fee: '$149/mo', color: 'text-[#38bdf8]' },
              { tier: 'SOVEREIGN', min: '$1,000,000', boost: '+1.40%', fee: 'Bespoke', color: 'text-purple-400' },
            ].map((m) => (
              <div key={m.tier} className="bg-[#161e2e] border border-[#1e293b] rounded-2xl p-5 space-y-2">
                <span className={`text-xs font-bold ${m.color}`}>{m.tier}</span>
                <div className="text-xs text-[#94a3b8] space-y-1">
                  <div>Min Balance: <strong className="text-white font-mono">{m.min}</strong></div>
                  <div>APY Boost: <strong className="text-emerald-400 font-mono">{m.boost}</strong></div>
                  <div>Maintenance: <strong className="text-white">{m.fee}</strong></div>
                </div>
              </div>
            ))}
          </div>
      ...
      {showGrantModal && (
        <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-3xl max-w-md w-full p-6 space-y-4">
            <h3 className="text-base font-bold text-white">Disburse Institutional Grant</h3>
            <form onSubmit={handleGrantSubmit} className="space-y-3 text-xs">
              <div>
                <label className="text-[#94a3b8] block mb-1">Grant Title / Initiative</label>
                <input
                  type="text"
                  required
                  value={grantTitle}
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">Recipient Client Email</label>
                <input
                  type="email"
                  required
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">Grant Amount (USD)</label>
                <input
                  type="number"
                  required
                  value={grantAmount}
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-[#1e293b]">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-amber-400 text-[#0b0f19] font-bold rounded-xl"
                >
      ...
      {showNewDepositModal && (
        <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#161e2e] border border-[#1e293b] rounded-3xl max-w-md w-full p-6 space-y-4">
            <h3 className="text-base font-bold text-white">Simulate Inbound Client Deposit</h3>
            <div className="space-y-3 text-xs">
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">Deposit Amount (USD)</label>
                <input
                  type="number"
                  value={depAmount}
              ...
              <div>
                <label className="text-[#94a3b8] block mb-1">Payment Method</label>
                <select
                  value={depMethod}
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-[#1e293b]">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-emerald-500 text-[#0b0f19] font-bold rounded-xl"
                >
