...
export default function AdminLoginPage() {
  ...
  const [email, setEmail] = useState('admin@crestlinecapital.internal')
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              {authMode === 'credentials' ? (
                <>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="admin@crestlinecapital.internal"
                  ...
                  <div className="p-3 bg-gray-50/80 rounded-2xl border border-gray-200 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2.5">
                      <div className="w-7 h-7 rounded-xl bg-green-100 text-green-600 flex items-center justify-center border border-emerald-500/20">
                        <UserCheck className="w-3.5 h-3.5" />
                      </div>
                      <div>
                        <span className="text-gray-900 font-medium block">Emmanuel Owighoyota</span>
                        <span className="text-[10px] text-gray-400 font-mono">
                          Role: SUPER_ADMIN (Full Clearance)
                        </span>
                      </div>
                    </div>
                    <span className="px-2 py-0.5 rounded text-[10px] font-mono font-semibold bg-green-100 text-green-600 border border-emerald-500/20">
                      Verified
                    </span>
                  </div>
