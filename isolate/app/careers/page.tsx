      ...
      <div className="pt-32 pb-20 px-4 max-w-5xl mx-auto">
        ...
        <div className="space-y-4">
          {jobs.map((job) => (
            <div
              key={job.title}
              className="bg-gray-100 border border-gray-200 rounded-2xl p-6 shadow-xl hover:border-[#D71E28]/40 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4"
            >
              <div>
                <span className="text-xs font-semibold text-[#D71E28] uppercase tracking-wider block mb-1">
                  {job.department}
                </span>
              ...
              <button
                ...
                className="px-5 py-2.5 bg-white hover:bg-[#D71E28] hover:text-gray-900 border border-gray-200 hover:border-transparent text-gray-900 font-bold text-xs rounded-xl transition-all self-start sm:self-center"
              >
                Apply Now
              </button>
            </div>
