      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">Business <span className="crest-text-gradient">Banking</span></h1>
              ...
              <div key={i} className="feature-card">
                ...
                <div className="flex flex-wrap gap-2">
                  {service.features.map((f, j) => (
                    <span key={j} className="text-xs px-2 py-1 rounded-md bg-[#D71E28]/10 text-[#D71E28]">{f}</span>
                  ))}
                </div>
              </div>
            ))}
