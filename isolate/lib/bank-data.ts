...
// Crestline Capital routing numbers by state and transaction type
...
export const BANKS_BY_REGION: Record<string, Bank[]> = {
  northeast: [
    ...
    {
      id: "Crestline_ny_ds",
      name: "Crestline Capital (Downstate)",
      routing: "021000021",
      region: "Northeast",
      state: "New York",
      type: "national",
    ...
    {
      id: "Crestline_ny_us",
      name: "Crestline Capital (Upstate)",
      routing: "022300173",
      region: "Northeast",
      state: "New York",
      type: "national",
  ...
  midwest: [
    ...
    // Ohio
    { id: "Crestline_oh", name: "Crestline Capital", routing: "044000037", region: "Midwest", state: "Ohio", type: "national" },
    ...
    // Indiana
    { id: "Crestline_in", name: "Crestline Capital", routing: "074000010", region: "Midwest", state: "Indiana", type: "national" },
    {
      id: "fifth_third_in",
      name: "Fifth Third Bank",
      routing: "074909962",
  ...
  south: [
    // Texas
    { id: "Crestline_tx", name: "Crestline Capital", routing: "111000614", region: "South", state: "Texas", type: "national" },
    ...
    // Florida
    { id: "Crestline_fl", name: "Crestline Capital", routing: "267084131", region: "South", state: "Florida", type: "national" },
    ...
    // Georgia
    { id: "Crestline_ga", name: "Crestline Capital", routing: "061092387", region: "South", state: "Georgia", type: "national" },
    ...
    // Louisiana
    { id: "Crestline_la", name: "Crestline Capital", routing: "065400137", region: "South", state: "Louisiana", type: "national" },
    {
      id: "regions_la",
      name: "Regions Bank",
      routing: "065403626",
    ...
    // Kentucky
    { id: "Crestline_ky", name: "Crestline Capital", routing: "083000137", region: "South", state: "Kentucky", type: "national" },
    ...
    // Oklahoma
    { id: "Crestline_ok", name: "Crestline Capital", routing: "103000648", region: "South", state: "Oklahoma", type: "national" },
  ...
  west: [
    // California
    { id: "Crestline_ca", name: "Crestline Capital", routing: "322271627", region: "West", state: "California", type: "national" },
    {
      id: "boa_ca",
      name: "Bank of America",
      routing: "121000358",
    ...
    // Washington
    { id: "Crestline_wa", name: "Crestline Capital", routing: "325070760", region: "West", state: "Washington", type: "national" },
    {
      id: "boa_wa",
      name: "Bank of America",
      routing: "125000024",
    ...
    // Oregon
    { id: "Crestline_or", name: "Crestline Capital", routing: "325070760", region: "West", state: "Oregon", type: "national" },
    ...
    // Arizona
    { id: "Crestline_az", name: "Crestline Capital", routing: "122100024", region: "West", state: "Arizona", type: "national" },
    ...
    // Nevada
    { id: "Crestline_nv", name: "Crestline Capital", routing: "322271627", region: "West", state: "Nevada", type: "national" },
    ...
    // Colorado
    { id: "Crestline_co", name: "Crestline Capital", routing: "102001017", region: "West", state: "Colorado", type: "national" },
    ...
    // Utah
    { id: "Crestline_ut", name: "Crestline Capital", routing: "124001545", region: "West", state: "Utah", type: "national" },
    ...
    // Idaho
    { id: "Crestline_id", name: "Crestline Capital", routing: "123271978", region: "West", state: "Idaho", type: "national" },
